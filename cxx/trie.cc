...
//typedef trie<string, mapped_type, cmp_fn, tag_type, 
//             trie_order_statistics_node_update> trie_type;
...
//  const pair_type match_range = t.find_by_order(key);
...
int main()
{
  ...
  // ext/pb_ds/defail/pat_trie_/insert_join_fn_imps.hpp
  // insert returns a pair, first is iter to location inserted, second is bool
  // if the insertion happened or or.
  auto r = t.insert("trie");
  cout << "repeat " << *(r.first) << ", " << r.second << endl;
